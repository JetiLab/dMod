...
#' 
#' @param x Object of class `eqnvec` or a
...
#' @param compile Logical. Directly compile the file. If `FALSE` and modelname is available,
#' the C file is written but not compiled. In this case, [compile] has to be called separately
#' to compile one or more .c-files into one .so-file. 
#' If modelname is not available, an R function is generated and returned.
#' @param modelname file name of the generated C file. See description of parameter `compile`.
...
#' @return Either a prediction function `f(..., attach.input = FALSE)` where the 
